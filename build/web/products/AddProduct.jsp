        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <jsp:include page="/includes/IncludeBreadCrumb.jsp">
                    <jsp:param name="path" value="Add Product" />
                </jsp:include>
                                    ...
                                    <form action="${pageContext.request.contextPath}/AddProductController" method="POST">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="inputStatus">Select Name</label>
                                                <select name="supplier_id" id="inputStatus" class="form-control custom-select" required>
                                                    <%
                                                    ...
                                                    %>
                                                    <option value="<%= sup_id%>"><%= Name%></option>
                                                    <%
                                                            }
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="inputDescription" name="description" class="form-control" rows="4" style="height: 63px;" placeholder="Enter Product Description" required></textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="quantity" class="form-control" id="exampleInputUsername" placeholder="Enter Quantity" required>
                                            </div>
